...
require (
	...
	github.com/openshift/hive/apis v0.0.0-20220801152137-97dd9aef3893
...
replace github.com/openshift/operator-custom-metrics => github.com/mjlshen/operator-custom-metrics v0.0.0-20220801185047-ce9fa26fc8eb
