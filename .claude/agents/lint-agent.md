...
Automated linting and code quality enforcement for the PagerDuty Operator.
...
Example: controllers/pagerdutyintegration/pagerdutyintegration_controller.go:42 [govet] unreachable code
```
