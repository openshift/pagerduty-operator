...
Security scanning and policy enforcement for the PagerDuty Operator.
...
- `controllers/pagerdutyintegration/` (secret handling via PagerDuty API key)
...
Example: [HIGH] [SECRET] main.go:42: Hardcoded API key detected
