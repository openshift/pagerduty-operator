#!/usr/bin/env bash
#
# Pre-Edit Hook for PagerDuty Operator
...
# Block edits to generated mocks (pkg/pagerduty/mock_service.go, pkg/pagerduty/service_mock.go)
if [[ "$FILE" == pkg/pagerduty/mock_*.go ]] || [[ "$FILE" == pkg/pagerduty/service_mock.go ]]; then
