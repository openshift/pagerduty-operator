...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcilePagerDutyIntegration{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner PagerDutyIntegration
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &pagerdutyv1alpha1.PagerDutyIntegration{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcilePagerDutyIntegration) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling PagerDutyIntegration")

	// Fetch the PagerDutyIntegration instance
	instance := &pagerdutyv1alpha1.PagerDutyIntegration{}
	...
	// Set PagerDutyIntegration instance as the owner and controller
...
func newPodForCR(cr *pagerdutyv1alpha1.PagerDutyIntegration) *corev1.Pod {
